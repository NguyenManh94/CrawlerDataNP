...
namespace SSWA_ExtractData.UserInterface
{
    public partial class FrmChangePass: XtraForm
    {
        ...
        private void FrmChangePass_Load(object sender, EventArgs e)
        {
            ...
            {
                var accoutInfor = permissionContex.Accounts.SingleOrDefault(a => (a.Id == FrmAuthentication.Id));
        ...
        private void barBtnSave_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    var accoutCurrent = permissionContext.Accounts.SingleOrDefault(a => (a.Id == FrmAuthentication.Id));
