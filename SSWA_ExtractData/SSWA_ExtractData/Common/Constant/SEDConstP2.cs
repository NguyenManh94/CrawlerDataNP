namespace SSWA_ExtractData.Common.Constant
{
    ...
    sealed partial class SEDConst
    {
        ...
        public const string MESSAGE_ACCOUNTLIST_STOP_ACCOUNT =
            "Do you want to stop the operation status of the account: '{0}' ?";
        ...
        public const string MESSAGE_DISCONNECT_CHECK =
            "Lost network connection. Please check connectivity to execute this task!";
        ...
        public const string MESSAGE_LINK_INVALID =
            "Linking data does not exist or is not feasible! Please choose another category!";

        /** MangNV1- Constans Warning Xpath*/

        public const string MESSAGE_EROR_XPATH =
            "Error handling systems !. Please send error on mailbox: nguyenmanhit.mak@gmail.com";
