...
// Code is generated on: 4/8/2016 5:20:06 PM
//
...
namespace PermissionContext
{
    ...
    public partial class RssPage : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        partial void OnNameChanging(string value);
        partial void OnNameChanged();
        partial void OnDisplayModeChanging(long value);
        ...
        /// </summary>
        [Column(Storage = "_DisplayMode", CanBeNull = false, DbType = "INTEGER NOT NULL", UpdateCheck = UpdateCheck.Never)]
